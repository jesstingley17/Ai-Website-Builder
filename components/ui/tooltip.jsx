...
export function Tooltip({ children, text, position = 'top' }) {
    ...
    return (
        ...
        >
            ...
            {isVisible && text && (
                <div
                    className={`absolute z-50 px-3 py-1.5 text-xs font-medium text-white bg-gray-900 rounded-lg shadow-lg pointer-events-none whitespace-nowrap border border-gray-700 animate-fade-in ${positionClasses[position]}`}
                >
                    {text}
                    {/* Arrow */}
                    <div
